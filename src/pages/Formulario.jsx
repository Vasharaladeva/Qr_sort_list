...
const AddParejaForm = () => {
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      const respuesta = await axios.post('http://localhost:2000/api/estudiante', formData);
      ...
      <ToastContainer />
        ...
        <form onSubmit={submitForm}>
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="mt-4 flex text-sm leading-6 text-gray-600">
                        ...
                        >
                          <span>Subir una foto</span>
                          <input id="imagenPermiso" name="imagenPermiso" type="file" className="sr-only" onChange={(e) => handleImageSelect(e.target.files[0], 'imagenPermiso')} />
                        </label>
                        <p className="pl-1">o arrastra y suelta</p>
                      </div>
                      <p className="text-xs leading-5 text-gray-600">PNG, JPG, GIF de hasta 10MB</p>
          ...
          {loading && (
            ...
            <SyncLoader color="#00BFFF" loading={true} />
          </div>
          )}
        </form>
    </>
